...
cdef void max_proba_bernstein_cin(
    DTYPE_t* p,
    SIZE_t n,
    SIZE_t* asc_sorted_indices,
    DTYPE_t* beta,
...
# Python interface
# =============================================================================
def py_max_proba_chernoff(
    np.ndarray[DTYPE_t, ndim=1] p, DTYPE_t beta, np.ndarray[DTYPE_t, ndim=1] v, reverse
):
    cdef SIZE_t* asc_idx
    cdef SIZE_t n = len(p)
...
def py_max_proba_bernstein_cin(
    np.ndarray[DTYPE_t, ndim=1, mode="c"] p,
