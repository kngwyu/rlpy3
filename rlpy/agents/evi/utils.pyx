...
cdef DTYPE_t check_end(
    DTYPE_t* x, DTYPE_t* y, SIZE_t dim, DTYPE_t* min_y, DTYPE_t* max_y
) nogil:
    cdef SIZE_t i, j
    cdef DTYPE_t diff
...
cdef void TopDownSplitMerge(
    SIZE_t* B, SIZE_t iBegin, SIZE_t iEnd, SIZE_t* A, DTYPE_t* X
) nogil:
    cdef SIZE_t iMiddle
...
cdef void TopDownMerge(
    SIZE_t* A, SIZE_t iBegin, SIZE_t iMiddle, SIZE_t iEnd, SIZE_t* B, DTYPE_t* X
) nogil:
    cdef SIZE_t i, j, k
    i = iBegin
    j = iMiddle
